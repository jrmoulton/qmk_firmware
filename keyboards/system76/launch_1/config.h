...
#define MATRIX_COL_PINS \
    { D7, C7, C6, B6, B5, B4, D6, D4, E6, D5, D3, D2, B7, B0 }
#define UNUSED_PINS
...
#    define RGB_MATRIX_STARTUP_MODE RGB_MATRIX_CUSTOM_active_keys // Sets the default mode, if none has been set
#    define RGB_MATRIX_STARTUP_HUE 147                            // Sets the default hue value, if none has been set
#    define RGB_MATRIX_STARTUP_SAT 209                            // Sets the default saturation value, if none has been set
